...
internal object SettingsDialog {
    ...
    fun show(context: Context, onSave: () -> Unit) {
        ...
        var commitAddons: () -> Unit = {} // <--- Diaktifkan balik
        ...
        // Active catalogs card (Hanya tinggal Simkl)
        ...
        // Stremio addons card (Diaktifkan balik!)
    ...
    fun buildCollapsibleCard(
        context: Context, title: String, startExpanded: Boolean = false,
        accentA: Int = SettingsTheme.ACCENT_START, accentB: Int = SettingsTheme.ACCENT_END,
    ...
    fun buildToggleRow(
        ...
        pending: MutableMap<String, Any?>, onChanged: () -> Unit = {}
    ): View {
        val theme   = SettingsTheme
    ...
    private fun buildConcurrencyRow(context: Context, pending: MutableMap<String, Any?>): View {
        val theme = SettingsTheme
